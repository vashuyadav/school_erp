                            ...
                            <table class="table table-hover text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('employee.edit', $id) }}" class="btn btn-info" title="Edit"><i class="fa fa-edit"></i></a>
                                            <a href="#" class="btn btn-danger" data-id="{{ $id }}" onclick="deleteRow(this);">
                                                <i class="fa fa-trash"></i>
                                            </a>
                                            <form id="delete-form-{{ $id }}" action="{{ route('employee.delete', $id) }}" method="POST" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </td>
